#include "Ground.hpp"
	...
	void Ground::drawMap(b2World* world, std::list <std::pair <float, float>> mapPoints){
		b2BodyDef ground;
        ...
        void Ground::render(sf::RenderTarget &rt) const {
	...
	std::list<std::pair<float, float>> Ground::generateGroundPoints(float difficulty, int length){
